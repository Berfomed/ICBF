...
namespace DatosBD
{
	...
	public partial class ORMcxBDDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteRegistroNinios(RegistroNinios instance);
		...
		public ORMcxBDDataContext() : 
				base(global::DatosBD.Properties.Settings.Default.FinalICBFConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public ORMcxBDDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ORMcxBDDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ORMcxBDDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public ORMcxBDDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Persona : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Registro_Jardin> _Registro_Jardin1;
    ...
    partial void OnidRolChanged();
		...
		public Persona()
		{
			...
			this._Registro_Jardin1 = new EntitySet<Registro_Jardin>(new Action<Registro_Jardin>(this.attach_Registro_Jardin1), new Action<Registro_Jardin>(this.detach_Registro_Jardin1));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Persona_Registro_Jardin1", Storage="_Registro_Jardin1", ThisKey="Cedula", OtherKey="IdMadreComunitaria")]
		public EntitySet<Registro_Jardin> Registro_Jardin1
		{
			get
			{
				return this._Registro_Jardin1;
			}
			set
			{
				this._Registro_Jardin1.Assign(value);
			}
		}
		...
		private void attach_Registro_Jardin1(Registro_Jardin entity)
		{
			this.SendPropertyChanging();
			entity.Persona1 = this;
		}
		
		private void detach_Registro_Jardin1(Registro_Jardin entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnIdMadreComunitariaChanged();
		...
		public long IdMadreComunitaria
		{
			...
			set
			{
				...
				{
					if ((this._Persona.HasLoadedOrAssignedValue || this._Persona1.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Persona_Registro_Jardin1", Storage="_Persona1", ThisKey="IdMadreComunitaria", OtherKey="Cedula", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Persona1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Registro_Jardin1.Remove(this);
					}
					this._Persona1.Entity = value;
					if ((value != null))
					{
						value.Registro_Jardin1.Add(this);
						this._IdMadreComunitaria = value.Cedula;
					}
					else
					{
