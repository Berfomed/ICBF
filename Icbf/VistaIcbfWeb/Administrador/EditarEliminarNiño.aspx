<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_Maestra.Master" AutoEventWireup="true" CodeBehind="EditarEliminarNiño.aspx.cs" Inherits="VistaIcbfWeb.Administrador.EditarEliminarNiño" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div style="width: 100%; margin-top: 4%">
        <div style="width: 70%; margin-left: 35%">
            <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="409px" AllowPaging="True" AutoGenerateRows="False" CellPadding="4" DataKeyNames="RegistroNIUP" DataSourceID="LinqDataSource1" ForeColor="#333333" GridLines="None">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <CommandRowStyle BackColor="#E2DED6" Font-Bold="True" />
                <EditRowStyle BackColor="#999999" />
                <FieldHeaderStyle BackColor="#E9ECF1" Font-Bold="True" />
                <Fields>
                    <asp:BoundField DataField="RegistroNIUP" HeaderText="RegistroNIUP" ReadOnly="True" SortExpression="RegistroNIUP" />
                    ...
                    <asp:BoundField DataField="CiudadNacimiento" HeaderText="CiudadNacimiento" SortExpression="CiudadNacimiento" />
                    <asp:BoundField DataField="DocAcudiente" HeaderText="DocAcudiente" SortExpression="DocAcudiente" />
                    <asp:BoundField DataField="Telefono" HeaderText="Telefono" SortExpression="Telefono" />
                    <asp:BoundField DataField="Direccion" HeaderText="Direccion" SortExpression="Direccion" />
                    <asp:BoundField DataField="EPS" HeaderText="EPS" SortExpression="EPS" />
                    <asp:BoundField DataField="IdJardin" HeaderText="IdJardin" SortExpression="IdJardin" />
            ...
            <div class="card border-warning mb-3" style="margin-left: 5%; border-left: 1px solid white">
                <div class="card-body text-warning">
                    ...
                    <p class="card-body text-warning">
                        Si deseas eliminar el registro de un infante, solo debes seleccionar la opción eliminar
