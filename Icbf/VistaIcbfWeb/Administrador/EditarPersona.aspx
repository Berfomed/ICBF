<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_Maestra.Master" AutoEventWireup="true" CodeBehind="EditarPersona.aspx.cs" Inherits="VistaIcbfWeb.Administrador.EditarPersona" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div style="width: 100%; margin-top: 4%">
        <div style="width: 70%; margin-left: 35%">
            <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="409px" AllowPaging="True" AutoGenerateRows="False" CellPadding="4" DataSourceID="LinqDataSource1" ForeColor="#333333" GridLines="None" DataKeyNames="Cedula">
