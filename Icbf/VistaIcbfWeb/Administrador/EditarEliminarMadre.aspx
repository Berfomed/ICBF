<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_Maestra.Master" AutoEventWireup="true" CodeBehind="EditarEliminarMadre.aspx.cs" Inherits="VistaIcbfWeb.Administrador.EditarEliminarMadre" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div style="width: 100%; margin-top: 4%">
        <div style="width: 70%; margin-left: 35%">
            <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="409px" AllowPaging="True" AutoGenerateRows="False" CellPadding="4" DataKeyNames="Cedula" DataSourceID="LinqDataSource1" ForeColor="#333333" GridLines="None">
            ...
            <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Datos.ORMicbfDataDataContext" EnableDelete="True" EnableUpdate="True" EntityTypeName="" TableName="Persona">
            </asp:LinqDataSource>
        </div>
